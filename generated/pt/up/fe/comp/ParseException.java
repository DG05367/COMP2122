...
public class ParseException extends RuntimeException implements JmmGrammarConstants {
    // The token we tripped up on.
    private Token token;
    //We were expecting one of these token types
    private EnumSet<TokenType> expectedTypes;
    private List<JmmGrammarParser.NonTerminalCall> callStack;
    private boolean alreadyAdjusted;
    public ParseException() {
        super();
    }

    public ParseException(Token token, EnumSet<TokenType> expectedTypes, List<JmmGrammarParser.NonTerminalCall> callStack) {
    ...
    public ParseException(JmmGrammarParser parser, String message) {
        super(message);
    ...
    public ParseException(JmmGrammarParser parser, EnumSet<TokenType> expectedTypes, List<JmmGrammarParser.NonTerminalCall> callStack) {
        this.token= parser.lastConsumedToken;
        if (token!=null&&token.getNext()!=null) {
            token= token.getNext();
        }
    ...
    @Override public String getMessage() {
        ...
        buf.append("\nFound string \""+JmmGrammarConstants.addEscapes(content)+"\" of type "+token.getType());
        return buf.toString();
    }
   ...
   */
    ...
    private void adjustStackTrace() {
        ...
        for (JmmGrammarParser.NonTerminalCall ntc : callStack) {
