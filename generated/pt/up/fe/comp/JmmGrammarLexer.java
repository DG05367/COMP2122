/* Generated by: JavaCC 21 Parser Generator. JmmGrammarLexer.java */
...
public class JmmGrammarLexer implements JmmGrammarConstants {
    ...
    static final EnumSet<TokenType> skippedTokens= EnumSet.of(_TOKEN_1, _TOKEN_2, _TOKEN_3, _TOKEN_4, _TOKEN_5, _TOKEN_6);
    ...
    public JmmGrammarLexer(CharSequence input) {
        this("input", input);
    }
    ...
    /**
      ...
      */
    public JmmGrammarLexer(String inputSource, CharSequence input) {
    ...
    /**
      ...
      * usages this is 1.
      */
    public JmmGrammarLexer(String inputSource, CharSequence input, LexicalState lexState, int startingLine, int startingColumn) {
        this.inputSource= inputSource;
     ...
     */
    public JmmGrammarLexer(Reader reader) {
     ...
     * depending on your use case
     */
    public JmmGrammarLexer(String inputSource, Reader reader) {
     ...
     * depending on your use case
     */
    public JmmGrammarLexer(String inputSource, Reader reader, LexicalState lexState, int line, int column) {
        this(inputSource, JmmGrammarConstants.readToEnd(reader), lexState, line, column);
        switchTo(lexState);
    }
   ...
   */
    ...
    private final Token nextToken() {
        ...
        while (matchedToken== null) {
            ...
            JmmGrammarNfaData.NfaFunction[] nfaFunctions= JmmGrammarNfaData.getFunctionTableMap(lexicalState);
            // the core NFA loop
            if (!reachedEnd) do {
